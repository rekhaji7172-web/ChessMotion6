...
class AppTheme {
  ...
  static const Color accent      = Color(0xFFF5A623); // Gold-orange
  static const Color accentLight = Color(0xFFFFCC02);
  static const Color accentRed   = Color(0xFFE53935); // Red (play button)
  static const Color accentCyan  = Color(0xFF00BCD4); // Cyan (film strip)
    ...
    return base.copyWith(
      ...
      switchTheme: SwitchThemeData(
        ...
        trackColor: WidgetStateProperty.resolveWith(
          (s) => s.contains(WidgetState.selected) ? const Color(0x80F5A623) : bgSurface,
        ),
      ),
  ...
  // ── Helper Methods ─────────────────────────────────────────────────
  static Color layerColorAt(int index) => layerColors[index % layerColors.length];
